# -*- coding: utf-8 -*-
"""
Build dense-only RAG index for sleep textbooks (VLM markdowns)
...
2) Do NOT use TOC. Treat each markdown as a whole document and split it
   with a fixed-size char-based window (no minimal-section splitting).
...
def main():
    ...
    log("[Done] Dense-only VLM index is ready.")


if __name__ == "__main__":
    main()
    print(search_dense("diagnostic criteria for insomnia disorder"))
